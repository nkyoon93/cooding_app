...
import 'package:cooding_app/utils/store.dart';
import 'package:cooding_app/ui/widgets/recipe_card.dart';
import 'package:cooding_app/model/state.dart';
...
class HomeScreenState extends State<HomeScreen> {
  ...
  TabBarView _buildTabsContent() {
    ...
    return TabBarView(
      children: [
        _buildRecipes(recipeType: RecipeType.easy),
        _buildRecipes(recipeType: RecipeType.hard),
